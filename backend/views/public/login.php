  ...
  <div class="login-box-body">
	...
	'template' => '{input}{error}',
      ...
      <div class="form-group has-feedback">
      	<?php echo $form->field($model,'adminuser')->textInput(["class" => "form-control","placeholder" =>"管理员账号"]);?>
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
      	<?php echo $form->field($model,'adminpass')->passwordInput(["class" => "form-control","placeholder" =>"管理员密码"]);?>
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      </div>
      <div class="row">
        <div class="col-xs-8">
        	<?php echo $form->field($model,'rememberMe')->checkbox([
            	'template' => '<label>{input}记住我</label>'
            	]);?>
        </div>
        <!-- /.col -->
        <div class="col-xs-4">
        	<?php echo Html::submitButton('登录', ["class" => "btn btn-primary btn-block btn-flat"])?>
        </div>
        <!-- /.col -->
      </div>
    ...
    <a href="<?php echo yii\helpers\Url::to(['public/seekpassword'])?>">忘记密码？</a><br>
