...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <?php if (Yii::$app->session->hasFlash('info')){
      ...
      <div class="form-group has-feedback">
      	<?php echo $form->field($model,'adminemail')->textInput(["class" => "form-control","placeholder" =>"管理员邮箱"]);?>
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      </div>
      <div class="row">

        <div class="col-xs-4">
        	<?php echo Html::submitButton('找回密码', ["class" => "btn btn-primary btn-block btn-flat"])?>
        </div>
        <!-- /.col -->
      </div>
